    ...
    >
      <template v-slot:item.productName="props">
        ...
        >
          ...
          <template v-slot:input>
            <div class="mt-4 text-h5">Zmień nazwę</div>
            <v-text-field
      ...
      <template v-slot:item.description="props">
        ...
        >
          ...
          <template v-slot:input>
            <div class="mt-4 text-h5">Zmień opis</div>
            <v-text-field v-model="props.item.description" counter autofocus>
            </v-text-field>
          </template>
        </v-edit-dialog>
      </template>
      <template v-slot:item.category.categoryName="props">
        ...
        >
          ...
          <template v-slot:input>
            <div class="mt-4 text-h5">Zmień kategorię</div>
            <v-select
      ...
      <template v-slot:item.price="props">
        ...
        >
          ...
          <template v-slot:input>
            <div class="mt-4 text-h5">Zmień cenę</div>
            <v-text-field
      ...
      <template v-slot:item.weight="props">
        ...
        >
          ...
          <template v-slot:input>
            <div class="mt-4 text-h5">Zmień wagę</div>
            <v-text-field
