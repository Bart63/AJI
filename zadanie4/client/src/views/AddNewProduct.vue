<template>
  <div class="add_product">
    ...
    <form @submit="submitProduct">
      ...
      <br />
      <v-btn type="Zapisz" color="lime darken-4" class="white--text">
        Submit
      </v-btn>
    </form>
  </div>
...
export default {
  methods: {
    ...
    _setFormName(value) {
      this.setProductForm({ key: "productName", value: value });
    },
    _setFormDescription(value) {
      this.setProductForm({ key: "description", value: value });
    },
    _setFormCategory(value) {
      this.setProductForm({ key: "category", value: value._id });
    },
    _setFormPrice(value) {
      this.setProductForm({ key: "price", value: value });
    },
    _setFormWeight(value) {
      this.setProductForm({ key: "weight", value: value });
    },
